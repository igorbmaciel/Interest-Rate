...
using InterestRate.Web.Service;
using InterestRate.Web.Extensions;

namespace InterestRate.Web
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILogger<Startup> logger, IHttpContextAccessor contextAccessor)
        {
            ...
            app.Run(context =>
            {
                context.Response.Redirect("/interestRate/swagger");
